...
external create :
  backend:string -> triple:string -> cpu:string -> debug_level:int -> t
  = "bap_disasm_create_stub" "noalloc"

external backends_size : unit -> int = "bap_disasm_backends_size_stub" "noalloc"
...
external set_offset : t -> int -> unit = "bap_disasm_set_offset_stub" "noalloc"
