...
module Markers = struct
  module Term = struct
    ...
    let () = unit synthetic ; unit live ; unit dead ; unit visited
  end
  ...
  module Arg = struct
    ...
    let () = unit alloc_size ; unit nonnull
  end

  module Has = struct let unit = unit "" "set" "has" end
...
module Comment = struct
  let () = Mappers.Unary.register "comment" @@ marker ident comment
end

module Python = struct
  let () = Mappers.Unary.register "python" @@ marker ident python
end
