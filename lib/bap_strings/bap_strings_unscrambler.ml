...
module Ascii = struct
  ...
  module Alpha = struct
    module Caseless = struct
      let length = 26 let index c = Char.uppercase c - 'A'
    end
  ...
  module Digits = struct let length = 10 let index c = c - '0' end
  ...
  module Printable = struct let length = 95 let index c = c - ' ' end
