...
external segment_name : t -> int -> string = "bap_llvm_binary_segment_name_stub"
external segment_addr : t -> int -> int64 = "bap_llvm_binary_segment_addr_stub"
external segment_size : t -> int -> int64 = "bap_llvm_binary_segment_size_stub"
...
external symbol_name : t -> int -> string = "bap_llvm_binary_symbol_name_stub"
external symbol_addr : t -> int -> int64 = "bap_llvm_binary_symbol_addr_stub"
external symbol_size : t -> int -> int64 = "bap_llvm_binary_symbol_size_stub"
...
external section_name : t -> int -> string = "bap_llvm_binary_section_name_stub"
external section_addr : t -> int -> int64 = "bap_llvm_binary_section_addr_stub"
external section_size : t -> int -> int64 = "bap_llvm_binary_section_size_stub"
external bap_llvm_load : Bigstring.t -> string -> string = "bap_llvm_load_stub"
