...
module Attr = struct
  type t = {name: string; args: string sexp_list}
  [@@deriving bin_io, compare, sexp]
end
...
module Spec = struct
  type ('a, 'b) t = {qualifier: 'a; t: 'b; attrs: attr sexp_list}
  [@@deriving bin_io, compare, sexp]
end
...
type aggregate =
  [`Array of (no_qualifier, t) spec | `Structure of (no_qualifier, t list) spec]
[@@deriving bin_io, compare, sexp]
