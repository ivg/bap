...
let binary3 op ~width ~expect x y ctxt =
  ...
  let equal (a, b, c) (a', b', c') =
    Word.equal a a' && Word.equal b b' && Word.equal c c' in
  let to_string (a, b, c) =
...
let suite () =
  ...
  >::: [ "13=13+1024|7" >:: normalized ~n:13 ~add:1024 ~width:7
       ...
       ; "chars:1|16le"
         >:: to_chars Word.(of_int 1 ~width:16) LittleEndian ~expect:[0x1; 0x0]
       ; "chars:1|16be"
       ...
       ; "chars:1|13le"
         >:: to_chars Word.(of_int 1 ~width:13) LittleEndian ~expect:[0x1; 0x0]
       ; "chars:1|13be"
       ...
       ; "concat:D7|3+5"
         >:: concat
               ...
               Word.(of_int 0x17 ~width:5); "with_zero:0" >:: is_zero Word.b0
