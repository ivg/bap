...
let divwe arch ctxt =
  ...
  let x =
    ...
    | _ -> Word.(signed (x lsl Word.of_int64 32L)) in
  let y = Word.signed (low y) in
...
let suite =
  "arith"
  >::: [ "neg" >:: neg `ppc; "subf" >:: subf `ppc; "subfic" >:: subfic `ppc
       ; "subfc" >:: subfc `ppc; "subfe" >:: subfe `ppc; "subme" >:: subfme `ppc
       ; "subze" >:: subfze `ppc; "mulli" >:: mulli `ppc; "mulhw" >:: mulhw `ppc
       ; "mulhwu" >:: mulhwu `ppc; "mullw" >:: mullw `ppc; "divw" >:: divw `ppc
       ; "divwu" >:: divwu `ppc; "divwe" >:: divwe `ppc
       ; "divweu" >:: divweu `ppc; "modsw" >:: modsw `ppc
       ; "moduw" >:: moduw `ppc; "neg 64" >:: neg `ppc64
       ; "subf 64" >:: subf `ppc64; "subfic 64" >:: subfic `ppc64
       ; "subfc 64" >:: subfc `ppc64; "subfe 64" >:: subfe `ppc64
       ; "subme 64" >:: subfme `ppc64; "subze 64" >:: subfze `ppc64
       ; "mulli 64" >:: mulli `ppc64; "mulhw 64" >:: mulhw `ppc64
       ; "mulhwu 64" >:: mulhwu `ppc64; "mullw 64" >:: mullw `ppc64
       ; "divw 64" >:: divw `ppc64; "divwu 64" >:: divwu `ppc64
       ; "divwe 64" >:: divwe `ppc64; "divweu 64" >:: divweu `ppc64
       ; "modsw 64" >:: modsw `ppc64; "moduw 64" >:: moduw `ppc64
       ; "mulld 64" >:: mulld; "mulhd 64" >:: mulhd; "mulhdu 64" >:: mulhdu
       ; "divd 64" >:: divd; "divdu 64" >:: divdu; "divde 64" >:: divde
       ; "divdeu 64" >:: divdeu; "modsd 64" >:: modsd; "modud 64" >:: modud ]
