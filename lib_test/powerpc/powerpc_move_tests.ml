...
let mtspr arch ctxt =
  ...
  let expected =
    match arch with `ppc -> Word.extract_exn ~hi:31 data | _ -> data in
...
let suite =
  "move"
  >::: [ "mtspr" >:: mtspr `ppc; "mfspr" >:: mfspr `ppc; "mtcrf" >:: mtcrf `ppc
       ; "mfcr" >:: mfcr `ppc; "mtspr 64" >:: mtspr `ppc64
       ; "mfspr 64" >:: mfspr `ppc64; "mtcrf 64" >:: mtcrf `ppc64
       ; "mfcr  64" >:: mfcr `ppc64 ]
