...
let suite =
  "add"
  >::: [ "addi32" >:: addi `ppc; "addi32_0" >:: addi_zero_op `ppc
       ; "addis32" >:: addis `ppc; "addis32_0" >:: addis_zero_op `ppc
       ; "add32" >:: add `ppc; "addic32" >:: addic `ppc; "addc32" >:: addc `ppc
       ; "adde32" >:: adde `ppc; "addme32" >:: addme `ppc
       ; "addze32" >:: addze `ppc; "add.32" >:: add_dot `ppc
       ; "addic.32" >:: addic_dot `ppc; "addc.32" >:: addc_dot `ppc
       ; "adde.32" >:: adde_dot `ppc; "addme.32" >:: addme_dot `ppc
       ; "addze.32" >:: addze_dot `ppc; "addi64" >:: addi `ppc64
       ; "addi64_0" >:: addi_zero_op `ppc64; "addis64" >:: addis `ppc64
       ; "addis64_0" >:: addis_zero_op `ppc64; "add64" >:: add `ppc64
       ; "addic64" >:: addic `ppc64; "addc64" >:: addc `ppc64
       ; "adde64" >:: adde `ppc64; "addme64" >:: addme `ppc64
       ; "addze64" >:: addze `ppc64; "add.64" >:: add_dot `ppc64
       ; "addic.64" >:: addic_dot `ppc64; "addc.64" >:: addc_dot `ppc64
       ; "adde.64" >:: adde_dot `ppc64; "addme.64" >:: addme_dot `ppc64
