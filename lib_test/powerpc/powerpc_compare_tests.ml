...
let cmp name ~opt_opcode l_field arch reg1_value reg2_value expected
  ...
  let fin = Word.b0 in
  let bytes =
    make_bytes [opcode; cr_field; Word.b0; l_field; reg1; reg2; opt_opcode; fin]
  in
  ...
  let init =
    Bil.
      ...
      ; reg2 := int @@ Word.of_int64 ~width reg2_value ] in
  let c = eval init bytes arch in
  assert_bool (sprintf "%s failed" name) @@ check c expected
...
let suite =
  ...
  >::: [ "cmpwi32: lt" >:: cmpwi `ppc 42L 44L LT
       ...
       ; "cmpdi: lt" >:: cmpdi 42L 44L LT; "cmpdi: gt" >:: cmpdi 44L 42L GT
       ...
       ; "cmpd: lt" >:: cmpd 42L 44L LT; "cmpd: gt" >:: cmpd 44L 42L GT
       ...
       ; "cmpldi: lt" >:: cmpldi 42L 44L LT; "cmpldi: gt" >:: cmpldi 44L 42L GT
       ...
       ; "cmpld: lt" >:: cmpld 42L 44L LT; "cmpld: gt" >:: cmpld 44L 42L GT
