...
let suite =
  "logical"
  >::: [ "andi.32" >:: andi_dot `ppc; "andis.32" >:: andis_dot `ppc
       ; "and32" >:: and_ `ppc; "and.32" >:: and_dot `ppc
       ; "andc32" >:: andc `ppc; "andc.32" >:: andc_dot `ppc
       ; "ori32" >:: ori `ppc; "oris32" >:: oris `ppc; "or32" >:: or_ `ppc
       ; "or.32" >:: or_dot `ppc; "orc32" >:: orc `ppc
       ; "orc.32" >:: orc_dot `ppc; "xori32" >:: xori `ppc
       ; "xoris23" >:: xoris `ppc; "xor32" >:: xor_ `ppc
       ; "xor.32" >:: xor_dot `ppc; "nand32" >:: nand `ppc
       ; "nand.32" >:: nand_dot `ppc; "nor32" >:: nor `ppc
       ; "nor.32" >:: nor_dot `ppc; "eqv32" >:: eqv `ppc
       ; "eqv.32" >:: eqv_dot `ppc; "extsb32" >:: extsb `ppc
       ; "extsh32" >:: extsh `ppc; "extsw32" >:: extsw `ppc
       ; "exts.32" >:: exts_dot `ppc; "cntlzw32: 1" >:: cntlzw `ppc 0x0 32
       ...
       ; "popcntw32" >:: popcntw `ppc; "andi.64" >:: andi_dot `ppc64
       ; "andis.64" >:: andis_dot `ppc64; "and64" >:: and_ `ppc64
       ; "and.64" >:: and_dot `ppc64; "andc64" >:: andc `ppc64
       ; "andc.64" >:: andc_dot `ppc64; "ori64" >:: ori `ppc64
       ; "oris64" >:: oris `ppc64; "or64" >:: or_ `ppc64
       ; "or.64" >:: or_dot `ppc64; "orc64" >:: orc `ppc64
       ; "orc.64" >:: orc_dot `ppc64; "xori64" >:: xori `ppc64
       ; "xoris64" >:: xoris `ppc64; "xor64" >:: xor_ `ppc64
       ; "xor.64" >:: xor_dot `ppc64; "nand64" >:: nand `ppc64
       ; "nand.64" >:: nand_dot `ppc64; "nor64" >:: nor `ppc64
       ; "nor.64" >:: nor_dot `ppc64; "eqv64" >:: eqv `ppc64
       ; "eqv.64" >:: eqv_dot `ppc64; "extsb64" >:: extsb `ppc64
       ; "extsh64" >:: extsh `ppc64; "extsw64" >:: extsw `ppc64
       ; "exts.64" >:: exts_dot `ppc64; "cntlz64: 1" >:: cntlzw `ppc64 0x0 32
       ...
       ; "cnttz64: 4" >:: cnttzw `ppc64 0x20 5; "cntlzd" >:: cntlzd
       ; "cnttzd" >:: cnttzd
       ; "cmpb64: 1"
       ...
       ; "popcntw64" >:: popcntw `ppc64; "popcntd" >:: popcntd
       ; "bperm64" >:: bperm ]
