...
let data ?(base = 0) ?(gap = 0) f ss asize name =
  ...
  List.map ss ~f:(fun data ->
      ...
      let dst = String.Table.find_or_add files name ~default:create_file in
  ...
  >::: [ "to_list:0-15/bytes_32LE"
       ...
       ; "to_list/0-15/int16_32LE"
         >:: to_list ~word_size:`r16 "0-15_32LE"
               ~expect:
                 [ 0x0100L; 0x0302L; 0x0504L; 0x0706L; 0x0908L; 0x0b0aL; 0x0d0cL
                 ; 0x0f0eL ]
       ; "to_list/0-15/int16_32BE"
         >:: to_list ~word_size:`r16 "0-15_32BE"
               ~expect:
                 [ 0x0001L; 0x0203L; 0x0405L; 0x0607L; 0x0809L; 0x0a0bL; 0x0c0dL
                 ; 0x0e0fL ]
