...
let insn_bil x =
  ...
  let mem = Or_error.ok_exn @@ Memory.create LittleEndian (Word.zero 32) bytes in
  let mem, insn =
    Or_error.ok_exn
...
let suite =
  "pcmp"
  >::: [ "pcmpeqb" >:: test_eqb; "pcmpgtb" >:: test_gtb; "pminub" >:: test_pminub
       ; "pminsb" >:: test_pminsb; "pmaxub" >:: test_pmaxub
       ; "pmaxsb" >:: test_pmaxsb; "pminuw" >:: test_pminuw
       ; "pminsw" >:: test_pminsw; "pmaxuw" >:: test_pmaxuw
       ; "pmaxsw" >:: test_pmaxsw; "pminud" >:: test_pminud
       ; "pminsd" >:: test_pminsd; "pmaxud" >:: test_pmaxud
       ; "pmaxsd" >:: test_pmaxsd ]
