...
let suite =
  "Future"
  >::: [ "fulfill" >:: fulfill; "is_fulfilled" >:: is_fulfilled
       ; "define_twice" >:: define_twice; "upon" >:: upon
       ; "is_decided" >:: is_decided; "peek" >:: peek; "peek_exn" >:: peek_exn
       ; "bind" >:: bind; "map" >:: map; "return" >:: return ]
