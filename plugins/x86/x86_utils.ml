...
module Cpu_exceptions = struct
  let general_protection = Bil.cpuexn 0xd let divide_by_zero = Bil.cpuexn 0x0
end
...
let bap_to_rflags =
  let undefined d =
    Bil.unknown (Printf.sprintf "Undefined RFLAGS bit %d" d) bool_t in
  ...
  @ [ undefined 31 (* 31 *); undefined 30 (* 30 *); undefined 29 (* 29 *)
    ; undefined 28 (* 28 *); undefined 27 (* 27 *); undefined 26 (* 26 *)
    ; undefined 25 (* 25 *); undefined 24 (* 24 *); undefined 23 (* 23 *)
    ; undefined 22 (* 22 *); unmodeled "ID" (* 21 *); unmodeled "VIP" (* 20 *)
    ; unmodeled "VIF" (* 19 *); unmodeled "AC" (* 18 *); unmodeled "VM" (* 17 *)
    ; unmodeled "RF" (* 16 *); undefined 15 (* 15 *); unmodeled "NT" (* 14 *)
    ; unmodeled "IOPL1" (* 13 *); unmodeled "IOPL2" (* 12 *)
    ; Bil.var oF (* 11 *); Bil.var df (* 10 *); unmodeled "IF" (*  9 *)
    ; unmodeled "TF" (*  8 *); Bil.var sf (*  7 *); Bil.var zf (*  6 *)
    ; undefined 5 (*  5 *); Bil.var af (*  4 *); undefined 3 (*  3 *)
    ; Bil.var pf (*  2 *); undefined 1 (*  1 *); Bil.var cf (*  0 *) ]
...
let rflags_to_bap =
  ...
  @ [ None (* 31 *); None (* 30 *); None (* 29 *); None (* 28 *); None (* 27 *)
    ; None (* 26 *); None (* 25 *); None (* 24 *); None (* 23 *); None (* 22 *)
    ; None (* 21 *); None (* 20 *); None (* 19 *); None (* 18 *); None (* 17 *)
    ; None (* 16 *); None (* 15 *); None (* 14 *); None (* 13 *); None (* 12 *)
    ; assn oF (* 11 *); assn df (* 10 *); None (* 09 *); None (* 08 *)
    ; assn sf (* 07 *); assn zf (* 06 *); None (* 05 *); assn af (* 04 *)
    ; None (* 03 *); assn pf (* 02 *); None (* 01 *); assn cf (* 00 *) ]
