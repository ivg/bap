...
module Scheme = struct
  ...
  let sexp_error (err : Sexp.parse_error) =
    let line, col =
      ...
      | `Sexp {parse_pos} -> (parse_pos.text_line, parse_pos.text_char) in
...
module Cmdline = struct
  ...
  let sub =
    [ "const"; "pure"; "stub"; "extern"; "leaf"; "malloc"; "noreturn"
    ; "return_twice"; "nothrow" ]
  ...
  module Predicates = struct
    ...
    let section =
      [ `S "STANDARD PREDICATES"; `I ("$(b,(true))", "Is always satisfied.")
      ...
      ; color "color"; color "foreground"; color "background"; term_attr "addr"
      ; term_field "tid"; term_field "name"; term_parent; def_lhs; def_uses
      ; `I
          ( "$(b,(taints))"
  ...
  module Mappers = struct
    ...
    let section =
      ...
      ; color "color"; color "foreground"; color "background"
      ; `I
          ( "$(b,(taint-reg TID))"
  ...
  let see_also = [`S "SEE ALSO"; `P "$(b,bap-plugin-taint)(1), $(b,bap-bml)(3)"]
